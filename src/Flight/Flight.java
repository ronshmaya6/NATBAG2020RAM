...
public abstract class Flight implements Comparable<Flight>,Cloneable  {
	...
	public void save(PrintWriter pw) {
		DateTimeFormatter format=DateTimeFormatter.ofPattern("dd/MM/yyyy");
		DateTimeFormatter formatTime=DateTimeFormatter.ofPattern("hh:mm");
		pw.print(this.dateArrivOrLend.format(format)+","+this.dateArrivOrLend.format(formatTime)+","+"LY"+this.numFlight+","+cityConnect+","
		+companyFlight+","+status.toString());
